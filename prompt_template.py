...
keyword_template = "根据考生提供的主观信息包含调剂学校:{target_school} 和调剂专业:{target_major}这两个信息生成3-8个检索关键词组,输出为list,例如:输入:调剂学校:厦门大学 调剂专业:计算机 生成检索关键词组：['厦门大学 计算机 调剂','厦门大学 信息学院 调剂','厦门大学 人工智能 调剂','厦门大学 计算机 调剂政策']。"
